...
export function useCreateManyAccount(
    options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.AccountCreateManyArgs, unknown>,
        'mutationFn'
    >,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
...
export function useInfiniteFindManyAccount<T extends Prisma.AccountFindManyArgs>(
    args?: Prisma.SelectSubset<T, Prisma.AccountFindManyArgs>,
    options?: Omit<UseInfiniteQueryOptions<Array<Prisma.AccountGetPayload<T>>>, 'queryKey'>,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useUpdateManyAccount(
    options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.AccountUpdateManyArgs, unknown>,
        'mutationFn'
    >,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
...
export function useDeleteManyAccount(
    options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.AccountDeleteManyArgs, unknown>,
        'mutationFn'
    >,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
